...
- **AI**: Google Gemini (`gemini-2.5-flash` for all analysis/cache/grounding/questions, `gemini-2.0-flash` for voice/dialogue, `MEDIA_RESOLUTION_LOW`, 1M token context, 90% cache discount)
